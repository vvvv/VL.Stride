...
namespace Stride.Rendering
{
    ...
    {
        public static readonly ValueParameterKey<Color4> ColorA = ParameterKeys.NewValue<Color4>(new Color4(0.60f,0.99f,0.96f,0.0f));
        public static readonly ValueParameterKey<Color4> ColorB = ParameterKeys.NewValue<Color4>(new Color4(0.57f,0.41f,0.07f,0.0f));
