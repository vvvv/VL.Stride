...
namespace Stride.Rendering
{
    public static partial class BlurRadialPass_Internal_TextureFXKeys
    {
        ...
        public static readonly ValueParameterKey<float> Rotate = ParameterKeys.NewValue<float>();
        public static readonly ValueParameterKey<float> Zoom = ParameterKeys.NewValue<float>();
