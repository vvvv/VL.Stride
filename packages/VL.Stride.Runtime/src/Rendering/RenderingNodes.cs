...
namespace VL.Stride.Rendering
{
    ...
    static class RenderingNodes
    {
        public static IEnumerable<IVLNodeDescription> GetNodeDescriptions(IVLNodeDescriptionFactory factory)
        {
            ...
            yield return factory.NewMeshNode((Models.ArrowMesh x) => (x.StickLength, x.StickRadius, x.HeadLength, x.HeadRadius, x.TipRadius, x.Tessellation, x.SharedVertices, x.Clockwise))
            ...
            yield return factory.NewMeshNode((Models.ConeMesh2 x) => (x.Radius, x.FromAngle, x.ToAngle, x.Height, x.Tessellation, x.VTessellation, x.LateralSlopeUVMode, x.SharedVertices, x.Clockwise))
                ...
                .AddCachedInput(nameof(Models.ConeMesh2.VTessellation), x => x.VTessellation, (x, v) => x.VTessellation = v, 2)
            ...
            yield return factory.NewMeshNode((Models.CylinderMesh2 x) => (x.Capped, x.BaseRadius, x.TopRadius, x.FromAngle, x.ToAngle, x.Height, x.Tessellation, x.VTessellation, x.SharedVertices, x.Clockwise))
                ...
                .AddCachedInput(nameof(Models.CylinderMesh2.VTessellation), x => x.VTessellation, (x, v) => x.VTessellation = v, 2)
