...
{
    /// <summary>
    /// Class used to generate a Stride Open cylinder model mesh using geometry3Sharp
    /// </summary>
    [DataContract("OpenCylinderModel")]
    [Display("OpenCylinderModel")] // This name shows up in the procedural model dropdown list
    public class OpenCylinderModel : PrimitiveProceduralModelBase
    {
        /// <summary>
        ...
        protected override GeometricMeshData<VertexPositionNormalTexture> CreatePrimitiveMeshData()
        {
            ...
            return Utils.ToGeometricMeshData(meshGenerator.Generate().MakeDMesh(), "OpenCylinderModel");
        }
    }
}
