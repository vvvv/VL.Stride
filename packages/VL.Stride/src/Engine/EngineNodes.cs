...
namespace VL.Stride.Engine
{
    static class EngineNodes
    {
        ...
        {
            var engineCategory = "Stride.Engine.Advanced";
            ...
            // Light components
            yield return factory.NewComponentNode<LightComponent>(engineComponentsCategory)
            ...
            yield return factory.NewComponentNode<LightShaftComponent>(engineComponentsCategory)
            ...
            yield return factory.NewComponentNode<LightShaftBoundingVolumeComponent>(engineComponentsCategory)
