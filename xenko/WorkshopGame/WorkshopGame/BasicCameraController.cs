...
namespace WorkshopGame
{
    ...
    public class BasicCameraController : SyncScript
    {
        ...
        private VL.Xenko.Rendering.LayerRenderFeature x;
        ...
        public Vector3 KeyboardMovementSpeed { get; set; } = new Vector3(6.0f);
        ...
        {
            x = new VL.Xenko.Rendering.LayerRenderFeature();
            base.Start();
